...
local themes = {
    ...
    Green = {
        TextColor = Color3.fromRGB(255, 255, 255),
        MainFrame = Color3.fromRGB(112,135,107),
        TabBackground = Color3.fromRGB(99, 135, 92),
        Tab = Color3.fromRGB(30, 30, 30),
        EnabledText = Color3.fromRGB(255, 255, 255),
        DisabledText = Color3.fromRGB(180, 180, 180),
        TabToggleEnabled = Color3.fromRGB(30, 30, 30),
        TabToggleDisabled = Color3.fromRGB(5, 5, 5),
        TabToggleDisabledMouseOver = Color3.fromRGB(20, 20, 20),
        Section = Color3.fromRGB(112,100,107),
        Button = Color3.fromRGB(112,150,107),
        ButtonMouseOver = Color3.fromRGB(112,135,107),
        ToggleEnabled = Color3.fromRGB(112,180,107),
        ToggleEnabledMouseOver = Color3.fromRGB(112,185,107),
        ToggleDisabled = Color3.fromRGB(30, 30, 30),
        ToggleDisabledMouseOver = Color3.fromRGB(40, 40, 40),
        Box = Color3.fromRGB(112,130,107),
        BoxFocused = Color3.fromRGB(112,138,107),
        Slider = Color3.fromRGB(30, 30, 30),
        SliderMouseOver = Color3.fromRGB(40, 40, 40),
        SliderFill = Color3.fromRGB(112,150,107),
        SliderFillSliding = Color3.fromRGB(112,160,107),
        Dropdown = Color3.fromRGB(112,120,107),
        DropdownMouseOver = Color3.fromRGB(112,128,107),
        DropdownContent = Color3.fromRGB(20, 20, 20),
        ColorPicker = Color3.fromRGB(112,140,107),
        ColorPickerBoxes = Color3.fromRGB(112,145,107)
    },
    Light = {
